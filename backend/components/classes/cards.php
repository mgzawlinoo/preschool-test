        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <?php elseif($class['status'] == 'inactive') : ?>
                ...
                <div class="mb-3">
                    ...
                    <p class="text-muted mb-2">Age Group: <?= $class['age_group'] ?></p>
                    <p class="text-muted mb-0">Schedule: <?= $class['schedule'] ?></p>
                    <p class="text-muted mb-0">Amount: <?= $class['fees'] ?></p>
                </div>
                ...
                <div class="d-flex justify-content-between text-muted small mb-3">
                    <span><?= $class['max_students'] ?> Students</span>
